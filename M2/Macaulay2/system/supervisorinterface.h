...
extern struct ThreadTask *createThreadTask(
...
static void **TS_Get_LocalArray()
{
  return (void **)pthread_getspecific(*(pthread_key_t *)threadSupervisor.ptr());
}
static void **TS_Get_Local(int refno)
{
  return &TS_Get_LocalArray()[refno];
}
#endif
